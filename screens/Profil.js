...
class  Profil extends Component {
    render() {
        ...
        <View style={{ height: 45, width:  300, backgroundColor: '#FFCCBC', borderRadius: 10,
   marginTop: 3, paddingTop:9  }}>
        <Text style={styles.baseText} >Arkadaşlar(232)
        </Text>
        </View>
        <View style={{ height: 45, width:  300, backgroundColor: '#FFAB91', borderRadius: 10,
    marginTop: 3, paddingTop: 9   }}>
        <Text style={styles.baseText} > Yaşadığı yer:  
        <Text style={styles.infoText} >Yaşadığı yer </Text>
        </Text>
        </View>
        <View style={{ height: 45, width:  300, backgroundColor: '#FF8A65', borderRadius: 10,
    marginTop: 3, paddingTop: 9   }}>
        <Text style={styles.baseText} >Doğum tarihii:  
        <Text style={styles.infoText} >Doğum tarihi </Text>
        </Text>
        </View>
         <View style={{ height: 45, width:  300, backgroundColor: '#FF7043', borderRadius: 10,
    marginTop: 3, paddingTop: 9   }}>
        <Text style={styles.baseText} >Diller:  
        <Text style={styles.infoText} >Diller </Text>
        </Text>
        </View>
        <View style={{ height: 45, width:  300, backgroundColor: '#FF5722', borderRadius: 10,
    marginTop: 3, paddingTop: 9   }}>
        <Text style={styles.baseText} >Hobiler:  
        <Text style={styles.infoText} >Hobiler </Text>
        </Text>
        </View>
        <View style={{ height: 45, width:  300, backgroundColor: '#DD2C00', borderRadius: 10,
    marginTop: 3, paddingTop: 9  }}>
        <Text style={styles.baseText} onPress={() => firebase.auth().signOut()} >  Çıkış Yap
